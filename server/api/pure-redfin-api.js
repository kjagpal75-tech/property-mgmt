...
/**
 * Pure Redfin Property Data API
 * Uses only Redfin market values - no county assessor fallback
 */
  ...
  try {
    ...
    try {
      ...
      const propertyData = await page.evaluate(() => {
        ...
        // Method 2: If no specific pattern found, use highest reasonable price
